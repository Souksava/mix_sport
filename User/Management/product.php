        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row" align="left">
                    ...
                    <div class="col-md-12 col-sm-6 form-control2">
                        <label>ເວລາຮັບປະກັນ</label>
                        <input type="text" name="varanty" id="varanty" placeholder="ເວລາຮັບປະກັນ" class="form-control">
                        <i class="fas fa-check-circle "></i>
                        <i class="fas fa-exclamation-circle "></i>
                        <small class="">Error message</small>
                    </div>
                    <div class="col-md-12 col-sm-6 form-control2">
                        <label>ຫົວໜ່ວຍເວລາ</label>
                        <input type="text" name="type" id="type" placeholder="ຫົວໜ່ວຍເວລາ" class="form-control">
                        <i class="fas fa-check-circle "></i>
                        <i class="fas fa-exclamation-circle "></i>
                        <small class="">Error message</small>
                    </div>
