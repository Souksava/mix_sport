...
{
   $id_sell = $_POST["query"];
   $update_seen = mysqli_query($conn,"update sell set seen2='1' where sell_id='$id_sell' ");
...
$no_ += 1;
  $output .= '
    <tr>
        ...
        $output .='
        <td>
           <img src="Administrator/image/'.$row["img"].'" class="img-circle elevation-2" alt="" width="55px" />
        </td>
