        ...
        <div class="col-xs-12 col-sm-6" align="right">
            <div style="width: 100%;">
                <div style="width: 82%;float: left;" align="right">
                    <form action="PDF-Reserv" method="POST" id="form_pdf" target="_blank">
                ...
                <div  style="width: 18%;float: left;">
                    <form action="Excel-Reserv" method="POST" id="form_pdf" target="_blank">
