<?php
  ...
  ?>
  <!-- modal orderdetail -->
<form action="OrderBill" id="form_order" method="POST" target="_blank">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="result_orderdetail"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">ຍົກເລີກ</button>
                    <button type="submit" name="btnBill" id="btnDelete_load" class="btn btn-outline-primary"
                        onclick="">
                        ພິມໃບສັ່ງຊື້
        ...
        <div class="col-xs-12 col-sm-6" align="right">
            <div style="width: 100%;">
                <div style="width: 82%;float: left;" align="right">
                    <form action="PDF-Order" method="POST" id="form_pdf" target="_blank">
                ...
                <div  style="width: 18%;float: left;">
                    <form action="Excel-Order" method="POST" id="form_pdf" target="_blank">
...
$(document).ready(function() {
    ...
    function load_data_selldetail(query, page) {
        $.ajax({
            url: "fetch_orderdetail.php",
            method: "POST",
            data: {
                query: query
            },
            success: function(data) {
                $("#result_orderdetail").html(data);
            }
        });
    }
