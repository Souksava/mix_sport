...
<div class="row">
    <div class="col-xs-12 col-sm-6">
        <form action="PDF-Supplier" method="POST" id="form_pdf" target="_blank">
    ...
    <div class="col-xs-12 col-sm-6" align="right">
        <form action="Excel-Supplier" method="POST" id="form_pdf" target="_blank">
